...
ENV BEDROCK_WEBRTC_PORT="0"
ENV BEDROCK_TRANSPORT="raknet"
ENV BEDROCK_SIGNALING_MODE="builtin"
ENV BEDROCK_SIGNALING_BUILTIN_HTTPS_CERTIFICATE=""
ENV BEDROCK_SIGNALING_BUILTIN_HTTPS_PRIVATE_KEY=""
ENV BEDROCK_SIGNALING_BUILTIN_HTTPS_PASSWORD=""
ENV BEDROCK_SIGNALING_NXS_ADVERTISE_ADDRESSES=""
ENV BEDROCK_SIGNALING_NXS_TOKEN=""
ENV BEDROCK_SIGNALING_NXS_ENDPOINT="https://agent.warden.cloud"
...
ENV GAMEPLAY_COOLDOWN_TYPE="crosshair"
...
ENV GAMEPLAY_BLOCK_LEGACY_CODES="true"
...
ENV ADVANCED_BEDROCK_USE_WATERDOGPE_FORWARDING="false"
ENV ADVANCED_BEDROCK_MTU="1400"
ENV ADVANCED_BEDROCK_VALIDATE_BEDROCK_LOGIN="true"
ENV ENABLE_METRICS="false"
ENV METRICS_UUID="f68d0052-34f4-4169-b424-43d63b7d4743"
